...
(:durative-action bomb-london2_101
	:parameters ()
	:duration (and (>= ?duration 0.1) (<= ?duration 0.1))
	:condition (and
		(at start (not (drone2-busy)))
...
(:durative-action bomb-london1_111
	:parameters ()
	:duration (and (>= ?duration 0.1) (<= ?duration 0.1))
	:condition (and
		(at start (not (drone1-busy)))
...
(:durative-action bomb-london1_121
	:parameters ()
	:duration (and (>= ?duration 0.1) (<= ?duration 0.1))
	:condition (and
		(at start (not (drone1-busy)))
...
(:durative-action bomb-london1_131
	:parameters ()
	:duration (and (>= ?duration 0.1) (<= ?duration 0.1))
	:condition (and
		(at start (not (drone1-busy)))
...
(:durative-action bomb-london1_141
	:parameters ()
	:duration (and (>= ?duration 0.1) (<= ?duration 0.1))
	:condition (and
		(at start (not (drone1-busy)))
...
(:durative-action bomb-london1_151
	:parameters ()
	:duration (and (>= ?duration 0.1) (<= ?duration 0.1))
	:condition (and
		(at start (not (drone1-busy)))
...
(:durative-action bomb-rome1_111
	:parameters ()
	:duration (and (>= ?duration 0.1) (<= ?duration 0.1))
	:condition (and
		(at start (not (drone1-busy)))
...
(:durative-action bomb-rome1_121
	:parameters ()
	:duration (and (>= ?duration 0.1) (<= ?duration 0.1))
	:condition (and
		(at start (not (drone1-busy)))
...
(:durative-action bomb-rome1_131
	:parameters ()
	:duration (and (>= ?duration 0.1) (<= ?duration 0.1))
	:condition (and
		(at start (not (drone1-busy)))
...
(:durative-action bomb-rome1_141
	:parameters ()
	:duration (and (>= ?duration 0.1) (<= ?duration 0.1))
	:condition (and
		(at start (not (drone1-busy)))
...
(:durative-action bomb-rome1_151
	:parameters ()
	:duration (and (>= ?duration 0.1) (<= ?duration 0.1))
	:condition (and
		(at start (not (drone1-busy)))
...
(:durative-action bomb-paris2_111
	:parameters ()
	:duration (and (>= ?duration 0.1) (<= ?duration 0.1))
	:condition (and
		(at start (not (drone2-busy)))
...
(:durative-action bomb-paris2_121
	:parameters ()
	:duration (and (>= ?duration 0.1) (<= ?duration 0.1))
	:condition (and
		(at start (not (drone2-busy)))
...
(:durative-action bomb-paris2_131
	:parameters ()
	:duration (and (>= ?duration 0.1) (<= ?duration 0.1))
	:condition (and
		(at start (not (drone2-busy)))
...
(:durative-action bomb-paris2_141
	:parameters ()
	:duration (and (>= ?duration 0.1) (<= ?duration 0.1))
	:condition (and
		(at start (not (drone2-busy)))
...
(:durative-action bomb-paris2_151
	:parameters ()
	:duration (and (>= ?duration 0.1) (<= ?duration 0.1))
	:condition (and
		(at start (not (drone2-busy)))
